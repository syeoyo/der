...
\begin{subequations}
    \begin{align}
        ...
        &y^-_{it}(\xi) \leq M_1 \phi^2_{it}(\xi), \quad z^C_{it}(\xi) \leq M_1 (1 - \phi^2_{it}(\xi)) &\\
        &z^C_{it}(\xi) \leq M_1 \phi^3_{it}(\xi), \quad z^D_{it}(\xi) \leq M_1 (1 - \phi^3_{it}(\xi)) &\\
        &\sum_{i \in I}e^+_{it}(\xi) \leq M_2 \phi^4_{it}(\xi), \quad \sum_{i \in I}e^-_{it}(\xi) \leq M_2 (1 - \phi^4_{it}(\xi))&
    \end{align}
\end{subequations}
...
\begin{subequations}
    \begin{align}
        ...
        &d^+_{it}(\xi) \leq M \phi^4_{it}(\xi), \quad d^-_{it}(\xi) \leq M (1 - \phi^4_{it}(\xi))&
    \end{align}
\end{subequations}
